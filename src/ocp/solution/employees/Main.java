...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employeeFilter.filter(employees, new EmployeeGenderSpecification(Gender.MALE))
            .forEach(System.out::println);

        System.out.println("All Female Employees:");
        employeeFilter.filter(employees, new EmployeeGenderSpecification(Gender.FEMALE))
            .forEach(System.out::println);

        // Or you can provide specification as lambda's
        System.out.println("All Employee with salary more than 50_000");
        employeeFilter.filter(employees, employee -> employee.getSalary() > 50_000)
            .forEach(System.out::println);
    }
}
